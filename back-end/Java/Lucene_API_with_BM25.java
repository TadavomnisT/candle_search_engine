...
public class Lucene_API_with_BM25 {
  ...
  public static void main(String[] args) throws IOException {
    String error_message = "Check input arguments.\n Usage: java Lucene_API_with_BM25 switch{-query/-index} parameter(s){if using -index must be JSON-encoded} \n Examples: \n\t java Lucene_API_with_BM25 -index {\"directories\":[\".\\/documents\"],\"files\":[],\"links\":[]} \n\t java Lucene_API_with_BM25 -query \"PHP programming\"  ";
    Lucene_API_with_BM25 indexer = new Lucene_API_with_BM25(indexPath);
   ...
   */
  Lucene_API_with_BM25(String indexDir) throws IOException {
...
// How to compile? ======================================================
// javac -cp "./includes/lucene-analyzers-common-4.0.0.jar:includes/lucene-core-4.0.0.jar:includes/lucene-queryparser-4.0.0.jar:includes/json-20211205.jar" Lucene_API_with_BM25.java                                                             

// How to execute? ======================================================
// java -cp .:includes/json-20211205.jar:includes/lucene-core-4.0.0.jar:includes/lucene-analyzers-common-4.0.0.jar:includes/lucene-queryparser-4.0.0.jar:includes/lucene-queryparser-4.0.0.jar Lucene_API_with_BM25 -index "{\"directories\":[\".\/documents\"],\"files\":[],\"links\":[]}"
